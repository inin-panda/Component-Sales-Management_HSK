...
public class GD_QL_NhanSu extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GD_QL_NhanSu frame = new GD_QL_NhanSu();
	...
	public GD_QL_NhanSu() {
		...
		JLabel lblXinChao = new JLabel("QUẢN LÝ NHÂN SỰ");
		lblXinChao.setBackground(new Color(238, 238, 238));
		lblXinChao.setBounds(0, 0, 286, 49);
