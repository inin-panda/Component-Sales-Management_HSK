...
public class GD_Chinh_Admin extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GD_Chinh_Admin frame = new GD_Chinh_Admin();
	...
	public GD_Chinh_Admin() {
		...
		JLabel lblXinChao = new JLabel("QUẢN LÝ");
		lblXinChao.setBackground(new Color(238, 238, 238));
		lblXinChao.setBounds(0, 0, 198, 49);
...
//		btnDangXuat.setBackground(new Color(205, 221, 237));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(btnLoaiLinhKien)) {
			setPanel(new GD_LoaiLinhKien());
		}
		if (obj.equals(btnNhaCungCap)) {
