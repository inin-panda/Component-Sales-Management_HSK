...
public class GD_QL_BanHang extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GD_QL_BanHang frame = new GD_QL_BanHang();
	...
	public GD_QL_BanHang() {
		...
		JLabel lblXinChao = new JLabel("BÁN HÀNG");
